...
$24a533d2fd5d499d$var$cardTemplate.innerHTML = /*html*/ `
    <div class="quote-container">
        <p class="quote-text bd-text-small"><slot name="quote-text">"This is a quoted text"</slot></p>
        <p class="quote-caption bd-text-small"><slot name="quote-caption"> - name </slot></p>
    </div>
